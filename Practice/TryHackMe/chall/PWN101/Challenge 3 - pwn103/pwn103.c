...
void rules(){
    printf("\n📜 Rules:\n\n");
    printf("1️  Don't ping @everyone 😾\n");
    printf("2️  Don't rick roll anyone 😒 Rick roll yourself 😎\n");
    printf("3️  Don't post memes 😑, otherwise you'll become a meme 🤡\n");
    printf("4️  We know sharing is caring 🤗, But don't share your writeups here lmao🤦‍♂\n");
    printf("5️  Respect everyone in our community🤗\n\n");
    main();
}
