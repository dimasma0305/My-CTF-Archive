    ...
    try:
        ...
        if 'Plugin file not found' in r.text:
            ...
            if r.status_code == 200:
                with open(file_to_read.replace('/', '_'), 'wb') as f:
                    f.write(r.content)
            else:
...
def main():
    ...
    parser.add_argument('-host',dest='host',required=True, help="Target host")
    parser.add_argument('-file',dest='file',required=True, help="File to read")
